...
NUMBER_OF_OBSTACLES_ALGORITHMS = 3
NUMBER_OF_DEFAULT_BUTTONS = 3
TOTAL_NUMBER_OF_BUTTONS = NUMBER_OF_ALGORITHMS\
    + NUMBER_OF_DEFAULT_BUTTONS + NUMBER_OF_OBSTACLES_ALGORITHMS
BUTTON_AREA_SIZE = int((CANVAS_DIMENSION-SQUARE_SIZE)/TOTAL_NUMBER_OF_BUTTONS)
BUTTON_SIZE = BUTTON_AREA_SIZE - 1
MENU_BAR_HEIGHT = BUTTON_AREA_SIZE + SQUARE_SIZE
