...
from board import Board, a_star_pathfind,\
  dijkstras_pathfinding, double_dijkstras_pathfinding, shortest_path_dfs, shortest_path_bfs
...
was_pathfound = shortest_path_bfs(board.start_square, board.end_square)
if was_pathfound:
